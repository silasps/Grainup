...
export function FaqAdminClient({
  ...
  return (
    <div className="flex flex-col gap-6">
      <AdminHeader
        title="FAQ"
        subtitle="Perguntas frequentes agrupadas por categoria"
      />
      ...
      <div className="flex flex-col gap-3">
            ...
            <div key={cat.id} className="border rounded-lg overflow-hidden">
              <div className="flex items-center justify-between px-4 py-3 bg-muted/40">
                ...
                <div className="flex gap-1">
                  <Button size="icon" variant="ghost" className="h-7 w-7" title="Adicionar FAQ nesta categoria" onClick={() => openNewFaq(cat.id)}>
        ...
        {categories.length === 0 && faqs.length === 0 && (
          <div className="text-center py-16 text-muted-foreground">
            ...
            <p className="text-xs mt-1">Clique em "Nova categoria" e depois em "Nova FAQ" para começar.</p>
          </div>
        )}
      </div>
    </div>
