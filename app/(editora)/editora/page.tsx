  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative text-white overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl px-4 py-20 sm:py-28 lg:py-36 relative text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Button
              size="lg"
              className="bg-brand hover:bg-brand-700 text-white font-semibold px-8 h-12 text-base"
              asChild
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="bg-transparent border-white/70 text-white hover:bg-white hover:text-primary h-12 text-base"
              asChild
            >
