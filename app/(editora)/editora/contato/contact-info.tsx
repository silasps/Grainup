      ...
      {phone && (
        <div className="flex gap-4">
          ...
          <div>
            ...
            {waUrl ? (
              <a href={waUrl} target="_blank" rel="noopener noreferrer" suppressHydrationWarning className="block text-sm text-muted-foreground hover:text-brand transition-colors">
                {phone}
              </a>
            ) : (
